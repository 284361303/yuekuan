...
class TopicSuitAdapter(private val mList: List<Body>) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is TopicSuitLeftHolder) {
            ...
            holder.leftBinding.itemTopicSuitLeftIvCollect.setImageResource(if (body.favourite) R.mipmap.icon_collect_66 else R.mipmap.icon_uncollect_66)
            ...
            holder.rightBinding.itemTopicSuitRightIvCollect.setImageResource(if (body.favourite) R.mipmap.icon_collect_66 else R.mipmap.icon_uncollect_66)
            if (onClickListener != null) {
                holder.itemView.setOnClickListener {
                    onClickListener?.onItemClickListener(body, position)
                }
